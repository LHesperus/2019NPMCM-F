...
%% Dijkstra
% dij_out=Dijkstra1(graph,graph2,para,cor_pos.type,1);
dij_out.stop=1;
dij_out.stop2=0;
...
while dij_out.stop~=N
    dij_out=Dijkstra2(graph,graph2,para,cor_pos.type,dij_out.stop,dij_out.stop2,tmp,start_temp,cor_pos.x,cor_pos.y,cor_pos.z,dij_out.endb2);
